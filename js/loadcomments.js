...
*/
            ...
            function loadComments(comments_url,endcursor,shortcode){
                ...
                $.getJSON(comments_url,function(c_postdata){
                    ...
                    try{
                        for(var i=0;i<12/*&& c_loaded<count_comments*/;i++){
                    ...
                    if(nextpage /*&& c_loaded<24*2*/){
                        comments_url='https://www.instagram.com/graphql/query/?query_hash=bc3296d1ce80a24b1b6e40b1e72903f5&shortcode='+shortcode+'&first=12&after='+window.c_endcursor;
                        console.log(comments_url)
